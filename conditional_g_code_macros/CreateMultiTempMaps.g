...
M291 P"Create cold bed map?" S4 K{"No","Yes",} T10
if input = 1
...
M291 P"Create Low temp bed map?" S4 K{"No","Yes",} T10
if input = 1
	...
	M98 P"0:/macros/heating/soak_bed.g"
...
M291 P"Create medium temp bed map?" S4 K{"No","Yes",} T10
if input = 1
	echo "Heating for nextmap"
	M291 P"Heating for next map" R"Heating" S1 T3
...
M291 P"Create high temp bed map?" S4 K{"No","Yes",} T10
if input = 1
	echo "Heating for nextmap"
	M291 P"Heating for next map" R"Heating" S1 T3
	M190 R{var.HighTemp}
