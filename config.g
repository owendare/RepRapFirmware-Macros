...
M558 P9 C"^zprobe.in" H6 F600:120 T4800 A10 S0.03 R0.5 B0         ; set Z probe type to bltouch and the dive height + speeds
G31 P500 X26.2 Y-1 Z0.48                                  	; set Z probe trigger value, offset and trigger height
...
if !exists(global.HeaterCheckInterval)
	global HeaterCheckInterval=5 ; variable for use in daemon.g sets interval of heater checks
else
	set global.HeaterCheckInterval=5 ; variable for use in daemon.g sets interval of heater checks
...
M568 R0 S0 P0 A0 ; set heater on T0 to off
...
M955 P0 Q4000000 C"spi.cs3+spi.cs4" ; configure accelerometer
